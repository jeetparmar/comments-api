package com.almighty.constants;

public final class CommentMessages {

	private CommentMessages() {
	} // Prevent instantiation

	public static final String COMMENT_ID_INVALID = "Comment id is invalid.";
	public static final String PARENT_COMMENT_ID_INVALID = "Parent comment id is invalid.";
